  ...
  return (
    ...
    >
      ...
      <div className="uk-flex-auto ">
        <div ref={wrapperRef}>
          ...
          >
            <div className="uk-text-center uk-inline">
              <div
                className={`${
                  showData === "Projects" ? "dd-option" : "dd-selected"
                }`}
                onClick={() => {
              ...
              <div
                className={`${
                  showData === "About Me" ? "dd-option" : "dd-selected"
                } uk-padding uk-padding-remove-horizontal`}
                onClick={() => {
                  setShowData("About Me");
                  setDrop(false);
                }}
              >
                About Me
              ...
              <div
                className={`${
                  showData === "Contact" ? "dd-option" : "dd-selected"
                }`}
                onClick={() => {
                  setShowData("Contact");
                  setDrop(false);
        ...
        <span
          className={`${
            showData === "Contact" ? "selected" : "nav-link"
        ...
        <span
          className={`${
            showData === "About Me" ? "selected" : "nav-link"
          } uk-button uk-text-bold uk-float-right uk-visible@s`}
          onClick={() => setShowData("About Me")}
        >
          About Me
        </span>
        <span
          className={`${
            showData === "Projects" ? "selected" : "nav-link"
          } uk-button uk-text-bold uk-float-right uk-margin-remove-left uk-visible@s`}
          onClick={() => setShowData("Projects")}
        >
          Projects
        </span>
      </div>
