    ...
    <div className={"uk-animation-fade"}>
      ...
      <div className="custom-margin">
        ...
        >
          <img src={Mac} alt="" />
          <div
            className={`uk-animation-fade uk-overlay uk-position-bottom overlay-plate ${
              dark ? "uk-overlay-primary" : "uk-overlay-default"
            }`}
          >
            <p className="uk-margin-remove-bottom">
              <span className="uk-text-bold">McMaster University</span> -
              Computer Engineering{" "}
              <span className="uk-visible@s">Co-Op (2016-2021)</span>
            </p>
      ...
      >
        <div>
          ...
          >
            ...
            >
              <p className="uk-margin-remove-bottom">
                <span className="uk-text-bold">Myplanet</span> - Software
                Developer
              </p>
              <p className="uk-margin-small-top">May 2021 - July 2022</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          >
            ...
            >
              <p className="uk-margin-remove-bottom">
                <span className="uk-text-bold">Ciena</span> - Automation Tools
                Developer (Co-Op)
              </p>
        ...
        <div>
          ...
          >
            ...
            >
              <p className="uk-margin-remove-bottom">
                <span className="uk-text-bold">Solace</span> - Technical Support
                Specialist (Co-Op)
              </p>
        ...
        <div className={"uk-width-1-1 uk-flex uk-flex-center"}>
          ...
          >
            <div
              onClick={() => {
                if (displayImg !== 1) {
                  document.getElementById("video-player").src = mySources[1];
                  setDisplayImg(1);
                }
              }}
            >
            ...
            <div
              onClick={() => {
                if (displayImg !== 2) {
                  document.getElementById("video-player").src = mySources[2];
                  setDisplayImg(2);
                }
              }}
            >
            ...
            <div
              onClick={() => {
                if (displayImg !== 3) {
                  document.getElementById("video-player").src = mySources[3];
                  setDisplayImg(3);
                }
              }}
            >
